...
def _scenario_module(
    ...
    for key, label, value, unit in (
        ...
        ("highs_threads", "HiGHS threads per scenario", 1, "thread"),
        ("coordinator_threads", "Maximum parallel scenarios", 2, "scenarios"),

...
def _finance_module(
    *,
    ...
    calculations = [
        ...
        _calculation("finance.manual_quote", "Manual quote as final Net CAPEX", "gross_upfront_cost = upfront_cost = entered_quoted_Net_CAPEX; upfront_rebate = 0", "In the current one-click Analysis path, pricing_mode is manual_quotes. The standalone STC worksheet is excluded from both device-profile pricing and manual quotations.", ["selected solution quote"], "solar_battery/ci_annual_financial_comparison.py::compare_ci_annual_financial_scenarios", example=_manual_quote_example(finance_solutions, assumptions)),
    ...
    return _module(
        ...
        boundaries=[
            ...
            "STC worksheets are independent estimates. Neither legacy rebate profiles nor worksheet amounts affect current solution or finance costs; upfront_rebate_aud_ex_gst is zero.",

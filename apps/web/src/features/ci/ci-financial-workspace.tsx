...
function sizeMetricLabel(value: CiPriceItem["size_metric"]) {
  return value === "pv_kwp_dc" ? "PV kWp DC" : value === "pv_inverter_kw_ac" ? "PV inverter kW AC" : value === "battery_inverter_kw_ac" ? "Battery PCS kW AC" : value === "battery_kw_discharge" ? "Battery kW discharge" : "Battery kWh";
}
